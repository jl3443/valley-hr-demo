...
/* Region col widened to 28%, AI activity slimmed to 24% so every Valley
   footprint label stays on ONE LINE — no wrap. whitespace-nowrap on the
   region + activity cells as a belt-and-braces guard. */
const headers = [
  { label: "Region",            width: "w-[28%]" },
      ...
      <header className="flex items-center justify-between px-4 py-2.5 border-b border-divider">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[12px] tracking-[0.08em] uppercase text-surface-deep font-medium">
            US workforce snapshot · NJ · NY · FL · AL
          </span>
        </div>
